    ...
    <div class="air-grid">
      ...
      <div class="form-content">
        <div class="form-content-inner">
          ...
          <div class="the-form">
            <div class="w-form">
              <form name="wf-form-Formulario-de-Contacto" data-name="Formulario de Contacto" method="post">
                <input type="text" class="text-field w-input" maxlength="256" name="name" data-name="Name" placeholder="Nombre" id="name" required="">
                <input type="email" class="text-field-2 w-input" maxlength="256" name="email" data-name="Email" placeholder="Correo" id="email" required="">
                <textarea id="mensaje" name="mensaje" placeholder="Mensaje" maxlength="5000" data-name="mensaje" required="" class="textarea w-input"></textarea>
                <input type="submit" value="Enviar mensaje" data-wait="Enviando..." class="green-button w-button" id="boton-email">
              </form>
